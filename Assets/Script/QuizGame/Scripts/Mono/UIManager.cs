...
public class UIManager : MonoBehaviour {
    ...
    IEnumerator CalculateScore()
    {
        ...
        int final = events.CurrentFinalScore + score;
        //while (scoreValue < final)
        //{
        //    scoreValue++;
        ...
        //}
        var scoreMoreThanZero = final > 0;
        while (scoreMoreThanZero ? scoreValue < final : scoreValue > final)
        {
            scoreValue += scoreMoreThanZero ? 10 : -10;
            uIElements.ResolutionScoreText.text = scoreValue.ToString();
